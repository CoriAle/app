...
var source = {
  scripts: [paths.scripts + 'app.module.js',
    ...
    // Bar scripts
    paths.scripts + 'bar/**/*.module.js',
    paths.scripts + 'bar/**/*.js',
    // Auth scripts
    paths.scripts + 'auth/**/*.module.js',
    paths.scripts + 'auth/**/*.js'
  ],
  templates: {
...
gulp.task('vendor:base', function() {
  ...
  return gulp.src(vendor.base.source)
    ...
    .pipe($.if(isProduction, $.uglify().on('error', gutil.log)))
...
gulp.task('vendor:app', function() {
  ...
  return gulp.src(vendor.app.source, {
    ...
    .pipe(jsFilter)
    .pipe($.if(isProduction, $.uglify(vendorUglifyOpts).on('error', gutil.log)))
